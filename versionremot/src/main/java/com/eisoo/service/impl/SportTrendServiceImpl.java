...
public class SportTrendServiceImpl implements ISportTrendService {
    ...
    public Map<String,Object> getHotNew(BaseSearchDTO baseSearchDTO) {
        ...
        // 获得热力图
        Integer recent = sportPropertionMapper.getHotSpot(baseSearchDTO);
        ...
        //获得热力图 last Month
        Integer lastTwo = sportPropertionMapper.getHotSpot(baseSearchDTO);
...
//        }
        ...
        List<VenueDTO> trend = sportTrendMapper.getTrend(radix / 3.5, baseSearchDTO.getMonths(), baseSearchDTO.getCollege(), baseSearchDTO.getGrade());

        map.put("recent",recent);
        map.put("lastTwo",lastTwo);
        map.put("radix",radix);
//        map.put("hotRadix",hotRadix);
