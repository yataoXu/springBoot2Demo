...
import com.yatao.mybaties.MybatiesApplication;
import com.yatao.mybaties.common.dao.entity.User;
import com.yatao.mybaties.service.UserService;
...
import static org.hamcrest.Matchers.nullValue;
    ...
    @SpringBootTest(classes = {MybatiesApplication.class})// 指定启动类
    public class MybatiesApplicationTest {
        private static final Logger log = LoggerFactory.getLogger(MybatiesApplicationTest.class);
